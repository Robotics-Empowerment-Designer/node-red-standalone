module.exports = function (RED) {
    ...
    var clearTabletTopic = "temi/clear";
    var finishedTopic = "temi/clear/finished";
    ...
    function clearTablet(config) {
        ...
        this.on('input', async function (msg,send, done) {
            node.warn("Clear Tablet node was triggered.");
            ...
            var messageText = node.id;
            
            
            sendMessage(clearTabletTopic, messageText);
        });
    ...
    RED.nodes.registerType("clearTablet", clearTablet);
};