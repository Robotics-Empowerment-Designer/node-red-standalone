module.exports = function (RED) {
    ...
    var showVideoTopic = "temi/vid";
    var finishedTopic = "temi/vid/finished";
    ...
    function showVideo(config) {
        ...
        this.on('input', async function (msg,send,done) {
            node.warn("Show video node was triggered.");
            ...
            sendMessage(showVideoTopic, messageJSON);
        });
    ...
    RED.nodes.registerType("temiVideo", showVideo);
};