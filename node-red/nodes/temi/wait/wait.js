module.exports = function (RED) {
    ...
    function wait(config) {
        ...
        mqttClient.on('message', function (topic, message) {
            ...
            node.warn(`received message> ${receivedMessage}`);
            ...
            if (topic === nodeFinishedTopic && receivedMessage === "done") {
                ...
                node.warn("Received done message: " + message.toString());
        ...
        this.on('input', async function (msg, send, done) {
            node.warn("TemiWait node was triggered.");
            ...
            var messageText = config.text || "No time specification";
            var messageObject={
                time: messageText,
                id: node.id
            };
            ...
            sendMessage(waitTopic, messageJSON);
        });
    ...
    RED.nodes.registerType("temiWait", wait);
};