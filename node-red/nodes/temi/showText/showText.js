module.exports = function (RED) {
    ...
    var showTextTopic = "temi/txt";
    var finishedTopic = "temi/txt/finished";
    ...
    function showText(config) {
        ...
        this.on('input', async function (msg, send, done) {
            node.warn("Show Text node was triggered.");
            ...
            sendMessage(showTextTopic, messageJSON);
        });
    ...
    RED.nodes.registerType("temiText", showText);
};
